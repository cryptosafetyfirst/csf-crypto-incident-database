...
**Orchestrator Specification --- v1.4**
...
This specification permits the existence of additional non-public,
downstream governance artifacts used to validate editorial or
educational alignment (e.g., FAQ alignment or defensive coverage
checks).

These artifacts are read-only consumers of intelligence outputs,
generate no intelligence of their own, and have no authority to
influence taxonomy, prevention mapping, verdicts, risk scoring, or
weekly synthesis.

### Stability and Versioning

This document defines **version v1.4** of the orchestrator.
